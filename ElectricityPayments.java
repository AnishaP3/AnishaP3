 ...
 */
 ...
 public class ElectricityPayments {
  ...
  public ElectricityPayments() {

  }

  //Method to get cost of the electricity bill from the electricityBill file
  public ArrayList<String[]> getCostOfElectricityBillFromFile() {
    ...
    //Reading the electricityBill file to get the cost of the electricity bill
    try {
  ...
  //Method to update the amount paid in the electricity file
  public void updateTheAmountInElectricityFile() {
    ...
    // Reading the electricityBill file and finding the matching username and      
    ...
    // Loop to find the cost of the electricity bill and amount paid in the 
    // array and add the total cost and total amount paid 
    for(String[] userNameValue : userNameValues) {
      if(userNameValue[0].contains("Cost of the electricity bill")) {
    ...
    //Updating the amount paid if the user pays their electricity bill
    ...
    //Printing the updated electricity bill into a file
    try {
        FileWriter fw = new FileWriter(ELECTRICITY_BILL_FILE);
      ...
      System.out.println("The electricity bill details could not be printed into a file");
    }
